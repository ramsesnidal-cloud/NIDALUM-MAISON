  ...
  const mainSections = [
    {
      id: 1,
      title: 'Music',
      description: 'Experience the sonic dimensions of Nidalum creation',
      icon: '🎵',
      path: '/chants',
    ...
    },
    {
      id: 2,
      title: 'Fashion',
      description: 'Discover the visual expressions of Nidalum aesthetics',
      icon: '👗',
      path: '/fashion',
      color: 'from-luxury-gold/20 to-luxury-gold/5',
    ...
    },
    {
      id: 3,
      title: 'Perfume',
      description: 'Explore the aromatic essence of Nidalum creation',
      icon: '🌸',
      path: '/perfume',
      color: 'from-luxury-gold/20 to-luxury-gold/5',
      ...
      <section className="relative py-16 md:py-32 lg:py-48 px-4 sm:px-6 md:px-8 bg-dark-grey-bg border-t border-b border-luxury-gold/10">
        <div className="max-w-[100rem] mx-auto">
          ...
          >
            ...
            {/* Five Column Highlights - Featured Collections */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-6 lg:gap-4">
              ...
              >
                ...
                <h3 className="font-heading text-xl md:text-2xl tracking-widest text-luxury-text uppercase">
                  Music
                </h3>
                <p className="font-paragraph text-xs md:text-sm text-luxury-text/70">
              ...
              >
                ...
                <p className="font-paragraph text-xs md:text-sm text-luxury-text/70">
                  Explore the aromatic essence of Nidalum creation
                </p>
                <Link to="/perfume" className="inline-block text-luxury-gold hover:text-luxury-text transition-colors duration-300 text-xs tracking-widest uppercase">
                  Discover →
                </Link>
              </motion.div>
              ...
              >
                ...
                <p className="font-paragraph text-xs md:text-sm text-luxury-text/70">
                  Read books, articles, and official publications
                </p>
                <Link to="/publications" className="inline-block text-luxury-gold hover:text-luxury-text transition-colors duration-300 text-xs tracking-widest uppercase">
                  Read More →
                </Link>
              </motion.div>
