        ...
        <div className="relative max-w-[120rem] mx-auto">
          ...
          >
            ...
            <p className="font-paragraph text-xl text-foreground/80 max-w-4xl mx-auto leading-relaxed">
              {language === 'fr' ? 'Découvrez les fondamentaux de la langue Nidalum avec des exemples et des traductions' : 
               language === 'de' ? 'Entdecken Sie die Grundlagen der Nidalum-Sprache mit Beispielen und Übersetzungen' : 
               'Discover the fundamentals of the Nidalum language with examples and translations'}
            </p>
          </motion.div>
        </div>
      </section>
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    {item.traduction_fr && (
                      <div>
                        <p className="font-paragraph text-xs text-foreground/50 mb-1">
                          {language === 'fr' ? 'Traduction FR:' : language === 'de' ? 'Französische Übersetzung:' : 'French Translation:'}
                        </p>
                    ...
                    {item.exampleSentence && (
                      <div>
                        ...
                        <p className="font-paragraph text-foreground/70 italic">
                          {item.exampleSentence}
                        </p>
                      </div>
                    )}
