          ...
          >
            ...
            <div className="space-y-6 md:space-y-8 max-w-3xl mx-auto">
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-text/90">
                Fashion within NIDALUM is not seasonal, not decorative, and not performative.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-text/90">
                It is conceived as an extension of presence.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-gold/70">
                Each silhouette is approached as a sign. Each material as a memory. Each gesture as a code.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-text/80">
                NIDALUM FASHION does not dress the body.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-gold/70">
                It articulates identity through form, silence, and proportion.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-text/80">
                The garment appears when it is necessary.
              </p>
              <p className="font-paragraph text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed text-luxury-gold/70">
                Not before.
              </p>
